      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:block text-left">
            <p className="text-xs font-medium text-slate-900 dark:text-slate-100">ABDULRAHMAN SHAWI</p>
            <p className="text-[10px] text-slate-500 dark:text-slate-400 text-left">ADMIN</p>
          </div>
